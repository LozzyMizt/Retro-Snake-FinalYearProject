...
;; ==============
to north
  ask snake 0 [set heading 0 forward 1]
end

to west
  ask snake 0 [set heading 270 forward 1]
end

to east
  ask snake 0 [set heading 90 forward 1]
end

to south
  ask snake 0 [set heading 180 forward 1]
end
...
;    if fruits = red [
;      set fruits color black
;      set powerup powerup + 10
;      set score score + 10
;  ]
end
